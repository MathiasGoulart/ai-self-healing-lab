...
| E002 | Embedded AI + R01 fixed timeout | **Design frozen** — parameterization pending ([R01](../research/remediation-r01.md)) |
| E003 | External Agent + R01 fixed timeout | **Design frozen** — parameterization pending (paired with E002) |
